...
<form class="col-md-10" action="Cuestionario.php" enctype="multipart/form-data" method="post" >
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p6">
  </div>

  <br>
  <div class="mb-3">
    <label for="exampleInputText" class="form-label">¿Todas las personas en casa estan de acuerdo en adoptar?</label>
    <input type="text" class="form-control" id="exampleInputText" name="p7">
  </div>

  <br>
  <div class="mb-3">
    <label for="exampleInputText" class="form-label">¿Hay niños en casa?</label>
    <input type="text" class="form-control" id="exampleInputText" name="p8">
  </div>

  <br>
  <div class="mb-3">
    <label for="exampleInputText" class="form-label">Edades:</label>
    <input type="text" class="form-control" id="exampleInputText" name="p9">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p10">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p11">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p12">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p13">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p14">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p15">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p16">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p17">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p18">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p19">
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="p20">
  </div>
